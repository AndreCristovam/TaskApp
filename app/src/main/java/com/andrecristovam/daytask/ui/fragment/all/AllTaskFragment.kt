package com.andrecristovam.daytask.ui.fragment.all
...
import com.andrecristovam.daytask.databinding.FragmentAllTasksBinding
    ...
    override fun onCreateView(
        ...
        mListener = object : TaskListener {
            ...
            override fun onDelete(id: Int) {
                ...
                mViewModel.laodFragment(TaskConstants.FILTER.HOME)
            }

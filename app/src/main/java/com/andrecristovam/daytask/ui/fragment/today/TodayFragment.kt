package com.andrecristovam.daytask.ui.fragment.today
...
import com.andrecristovam.daytask.databinding.FragmentTodayBinding
    ...
    override fun onCreateView(
        ...
        mListener = object : TaskListener {
            ...
            override fun onDelete(id: Int) {
                ...
                mViewModel.laodFragment(TaskConstants.FILTER.TODAY)
            }
